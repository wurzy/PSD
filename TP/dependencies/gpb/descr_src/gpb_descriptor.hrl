...
-define(gpb_descriptor_gpb_version, "4.16.0").
...
-record('FileDescriptorProto',
        {name                   :: iodata() | undefined, % = 1, optional
         package                :: iodata() | undefined, % = 2, optional
         dependency = []        :: [iodata()] | undefined, % = 3, repeated
         ...
         syntax                 :: iodata() | undefined % = 12, optional
        }).
-endif.
...
-record('DescriptorProto',
        {name                   :: iodata() | undefined, % = 1, optional
         ...
         reserved_name = []     :: [iodata()] | undefined % = 10, repeated
        }).
-endif.
...
-record('FieldDescriptorProto',
        {name                   :: iodata() | undefined, % = 1, optional
         ...
         type_name              :: iodata() | undefined, % = 6, optional
         extendee               :: iodata() | undefined, % = 2, optional
         default_value          :: iodata() | undefined, % = 7, optional
         oneof_index            :: integer() | undefined, % = 9, optional, 32 bits
         json_name              :: iodata() | undefined, % = 10, optional
...
-record('EnumDescriptorProto',
        {name                   :: iodata() | undefined, % = 1, optional
         ...
         reserved_name = []     :: [iodata()] | undefined % = 5, repeated
        }).
-endif.
...
-record('MethodDescriptorProto',
        {name                   :: iodata() | undefined, % = 1, optional
         input_type             :: iodata() | undefined, % = 2, optional
         output_type            :: iodata() | undefined, % = 3, optional
...
-record('FileOptions',
        {java_package           :: iodata() | undefined, % = 1, optional
         java_outer_classname   :: iodata() | undefined, % = 8, optional
         ...
         go_package             :: iodata() | undefined, % = 11, optional
         ...
         objc_class_prefix      :: iodata() | undefined, % = 36, optional
         csharp_namespace       :: iodata() | undefined, % = 37, optional
         swift_prefix           :: iodata() | undefined, % = 39, optional
         php_class_prefix       :: iodata() | undefined, % = 40, optional
         php_namespace          :: iodata() | undefined, % = 41, optional
         php_metadata_namespace :: iodata() | undefined, % = 44, optional
         ruby_package           :: iodata() | undefined, % = 45, optional
         uninterpreted_option = [] :: [gpb_descriptor:'UninterpretedOption'()] | undefined % = 999, repeated
        }).
-endif.
...
-record('UninterpretedOption.NamePart',
        {name_part              :: iodata() | undefined, % = 1, required
...
-record('UninterpretedOption',
        {name = []              :: [gpb_descriptor:'UninterpretedOption.NamePart'()] | undefined, % = 2, repeated
         identifier_value       :: iodata() | undefined, % = 3, optional
         ...
         aggregate_value        :: iodata() | undefined % = 8, optional
        }).
-endif.
...
-record('SourceCodeInfo.Location',
        {path = []              :: [integer()] | undefined, % = 1, repeated, 32 bits
         ...
         leading_comments       :: iodata() | undefined, % = 3, optional
         trailing_comments      :: iodata() | undefined, % = 4, optional
         leading_detached_comments = [] :: [iodata()] | undefined % = 6, repeated
        }).
-endif.
...
-record('GeneratedCodeInfo.Annotation',
        {path = []              :: [integer()] | undefined, % = 1, repeated, 32 bits
         source_file            :: iodata() | undefined, % = 2, optional
